	...
	<?php if ( 'updater' === $tab ) : ?>
		...
		<div class="vc_settings-activation-deactivation">
			...
			<?php else: ?>
				...
				<p class="description">
					<?php echo sprintf( __( 'W=P=L=O=C=K=E=R=.=C=O=M - Don\'t have valid license yet? <a href="%s" target="_blank">Purchase Visual Composer license</a>.', 'js_composer' ), esc_url( 'http://bit.ly/vcomposer' ) ) ?>
				</p>
